...
- **CI95** — Intervalo de confiança a 95%.
- **Swing** — Diferença entre o resultado atual e o histórico (em pp).
- **pp** — Pontos percentuais.
- **Tossup** — Faixa de incerteza onde nenhum candidato tem vantagem clara.
- **Chamada (call)** — Quando o modelo declara vitória com P(>50%) ≥ 95%.
